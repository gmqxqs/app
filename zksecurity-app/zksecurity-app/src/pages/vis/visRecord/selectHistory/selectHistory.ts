...
@Component({
  selector: 'page-selectHistory',
  templateUrl: 'selectHistory.html'
})

export class SelectHistory {
...
//获得本月的结束日期
  ...
  searchByTime() {
    this.navParams.data.refreshSelectByTime(this.filters, this.startTime, this.endTime);
    this.navCtrl.pop();
  }
